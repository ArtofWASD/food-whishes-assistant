  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in px-2">
      <div className="relative w-full max-w-2xl mx-auto">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-purple-50 to-pink-50 dark:from-blue-900/30 dark:via-purple-900/20 dark:to-pink-900/10 rounded-2xl blur-sm"></div>
        
        <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/30 p-6 md:p-8 max-h-[80vh] flex flex-col">
          {/* Header */}
